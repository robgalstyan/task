...
{{--        var rate = $(this).closest('.businesses').find('.rate input[type="radio"]:checked')[0].value;--}}
{{--        var review = $(this).closest('.businesses').find('textarea[name="review"]')[0].value;--}}
{{--        var id = $(this).data('business_id');--}}
{{--        $.ajax({--}}
{{--            url: BASE_URL+'/review/store/'+id,--}}
{{--            type: 'post',--}}
{{--            data: {--}}
{{--                'rate' : rate,--}}
{{--                'text' : review,--}}
